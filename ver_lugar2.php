  ...
  <tr>
    <td height="239" valign="bottom" background="assets/imgs/<? echo"$header";?>"><table width="732" height="173" border="0" align="right" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="267" valign="top"><div align="left"><img src="assets<? echo"$res[14]";?>" width="184" height="184" /></div></td>
      </tr>
    </table></td>
  </tr>
  ...
  <tr>
    <td valign="bottom">
      <table width="799" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
          <td width="23">&nbsp;</td>
          <td width="425"><div align="center"><img src="assets/<? echo"$res[10]";?>"  height="250" /></div></td>
          <td width="336" class="contenido"><div align="justify"><? echo"$res[13]";?></div></td>
          <td width="22">&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td class="style3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="13%">&nbsp;</td>
                <td width="87%" class="direccionLista"><? echo"$res[2]";?><br />
                <? echo"$res[3]";?></td>
              </tr>
          </table></td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td colspan="4"><table width="800" height="22" border="0" align="left" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td>&nbsp;</td>
                <td><p><span class="contenidoNegritas">Tel: </span><span class="contenido"><? echo"$res[4]";?></span>
                    <? if($res[5]!=""){?>
                      <span class="contenidoNegritas"><br />
                      Email: </span><span class="contenido"><? echo"$res[4]";?></span>
                  <? }?>				
                	<? if($res[7]!=""){?><br/>
        ...
        ?></td>
              ...
              <tr>
                ...
                <td valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="100" valign="top"><span class="contenido"><? echo"$res[6]";?></span></td>
                    </tr>
                    <tr>
                      <td><span class="subtitle">Beneficio Deluxe </span></td>
                    </tr>
                    <tr>
                ...
                <td ><iframe width="400" height="200" frameborder="0" scrolling="No" marginheight="0" marginwidth="0" src="<? echo"$res[11]";?>&output=embed"></iframe>
                    <br />
                    <small><a href="<? echo"$res[11]";?>" target="_blank" class="contenidoNegritas" >Ver mapa m&aacute;s grande</a></small></td>
                <td><img src="assets/imgs/comoLlegar.png" width="30" height="200" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td valign="bottom" ><span class="subtitle">Beneficio Diamante </span></td>
                <td>&nbsp;</td>
                <td >&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td valign="bottom" class="contenido" ><? echo"$res[25]";?></td>
                <td>&nbsp;</td>
                <td >&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
