...
<body>
<table width="806" height="657" border="0"  cellpadding="0" cellspacing="0">
  <tr>
    <td height="119" valign="top" background="images/<? echo"$header";?>"><table width="730" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
  ...
  <tr>
    <td height="100%" valign="top" background="images/fondo_lista.jpg" bgcolor="#000000"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      <?
...
?>
      <tr>
        <td><table width="350" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="128" valign="top"><a href="javascript:ver('detalle.php?id=<? echo"$id";?>&idE=<? echo"$res[0]";?>');" ><img src="assets<? echo"$res[2]";?>" width="128" height="128" border="0" /></a></td>
              ...
              <td width="202"><table width="202" border="0" cellspacing="2" cellpadding="0">
                  <tr>
                    <td><div align="left" class="subtitle"><a href="javascript:ver('detalle.php?id=<? echo"$id";?>&amp;idE=<? echo"$res[0]";?>');" class="subtitle"><? echo"$res[1]";?></a></div></td>
                  </tr>
                  <tr>
                    <td><div align="left" class="descrLista"><? echo"$res[5]";?></div></td>
                  </tr>
                  ...
                  <tr>
                    <td><div align="left" class="descuentoLista"><? echo"$res[4]";?></div></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td><table width="170" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="143"><div align="left" class="masLista"><a href="javascript:ver('detalle.php?id=<? echo"$id";?>&amp;idE=<? echo"$res[0]";?>');" class="masLista">Más...</a></div></td>
                        </tr>
                    </table></td>
                  </tr>
              </table></td>
    ...
    <td><table width="350" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="128" valign="top"><a href="javascript:ver('detalle.php?id=<? echo"$id";?>&amp;idE=<? echo"$res[0]";?>');" ></a></td>
        <td width="10"><img src="images/spacer.gif" width="20" height="20" /></td>
        <td width="202"><table width="202" border="0" cellspacing="2" cellpadding="0">
            <tr>
            ...
            <tr>
              <td><table width="170" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="17">&nbsp;</td>
                    <td width="10"><img src="images/spacer.gif" width="10" height="10" /></td>
                    <td width="143"><div align="left" class="masLista"><a href="javascript:ver('detalle.php?id=<? echo"$id";?>&amp;idE=<? echo"$res[0]";?>');" class="masLista"></a></div></td>
                  </tr>
              </table></td>
            </tr>
        </table></td>
...
?>
  ...
  <tr>
    <td height="204" background="images/abajo_lista.jpg">&nbsp;</td>
  </tr>
</table>
</body>
</html>
