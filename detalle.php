          ...
          <td valign="top"><table width="300" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td valign="top" class="style1"><div align="justify"><p>
                  <br />
                  <small><a href="<?php echo"$res[11]";?>" target="_blank" class="contenidoNegritas" >Ver mapa</a></small></p></div></td>
            </tr>
          </table></td>
          <td valign="top"><table width="300" border="0" cellspacing="0" cellpadding="0">
              <tr>
              ...
              <tr>
                <td class="style1"><div align="justify">
                    <p><span class="benedicio"><?php echo"$res[24]";?></span><br />
...
<?php }?></div></p></td>
  ...
  <tr>
    <td height="204" valign="top" background="images/abajo_lista.jpg"><table width="718" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="132"><?php if($res[35]!=""){?>
            <a class="group1" href="assets<?php echo"$res[35]";?>" title="<?php echo"$res[1]";?>"><img src="assets<?php echo"$res[35]";?>" width="132" height="87" border="0" /></a>
            <?php }else echo"&nbsp;";?></td>
        <td width="13">&nbsp;</td>
        <td width="135"><?php if($res[36]!=""){?>
            <a class="group1" href="assets<?php echo"$res[36]";?>" title="<?php echo"$res[1]";?>"><img src="assets<?php echo"$res[36]";?>" width="132" height="87" border="0" /></a>
            <?php }else echo"&nbsp;";?></td>
        <td width="10">&nbsp;</td>
        <td width="135"><?php if($res[37]!=""){?>
            <a class="group1" href="assets<?php echo"$res[37]";?>" title="<?php echo"$res[1]";?>"><img src="assets<?php echo"$res[37]";?>" width="132" height="87" border="0" /></a>
            <?php }else echo"&nbsp;";?></td>
        <td width="10">&nbsp;</td>
        <td width="135"><?php if($res[38]!=""){?>
            <a class="group1" href="assets<?php echo"$res[38]";?>" title="<?php echo"$res[1]";?>"><img src="assets<?php echo"$res[38]";?>" width="132" height="87" border="0" /></a>
            <?php }else echo"&nbsp;";?></td>
        <td width="10">&nbsp;</td>
        <td width="138"><?php if($res[39]!=""){?>
            <a class="group1" href="assets<?php echo"$res[39]";?>" title="<?php echo"$res[1]";?>"><img src="assets<?php echo"$res[39]";?>" width="132" height="87" border="0" /></a>
            <?php }else echo"&nbsp;";?></td>
      </tr>
    </table></td>
  </tr>
...
<?php		
	...
	while(@mysql_num_rows($resultado)>=$count){
		$res_img=mysql_fetch_row($resultado);
		?>
		 $('#zoom_0<?php echo"$count";?>').elevateZoom();
		<?php
		$count++;
	}
        ?>
