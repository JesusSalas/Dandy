...
<table width="822" height="323" border="0"  cellpadding="0" cellspacing="0" background="images/fondo_lista.jpg">

  <tr >

    <td height="119" valign="top" background="assets/imgs/titulo_puntos_venta.jpg"  style="background-repeat:no-repeat;"><table width="730" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<div style="height:642px;overflow-x:hidden;">

	<table width="806" height="642" border="0"  cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		$consulta  = "select Empresas.idEmpresa, Nombre, Logo, Direccion, promocion_normal, descripcion from Empresas  where PV=1 order by Nombre";//, Promocion1, Promocion2
          ...
          <tr>
            ...
            <td><table width="350" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="128" valign="top"><a href="javascript:ver('detalle.php?id=<?php echo"$id";?>&amp;idE=<? echo"$res[0]";?>');" ><img src="assets<?php echo"$res[2]";?>" width="128" height="128" border="0" /></a></td>
