...
//calculo fechas a mostrar en oficina
...
<body onload="window.location.href='#ventan'">
<div id="fb-root"></div>
                        ...
                        <td><div align="right">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="64%" height="21" class="style11"><div align="right"><a href="javascript:verframe('f_home.php?redirect=f_home.php');" class="letrasMenu"  >HOME</a></div></td>
                        ...
                        <td><div align="right">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td width="73%" height="21" class="style11"><div align="right"><a href="<?php  if($_SESSION['usuario']==""){ echo"javascript:verframe('f_usuarios.php?redirect=f_usuarios')";}else{ echo"valida.php";}?>" class="letrasMenu <?php  if($_SESSION['usuario']!="") echo"iframe";?>" >REGISTRO</a></div></td>
                                <td width="15%" class="style11">&nbsp;</td>
                              </tr>
                              </table>
                        </div></td>
                      ...
                      <tr>
                        <td><div align="right">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="12%" class="style11">&nbsp;</td>
                                <td width="75%" height="21" class="style11"><div align="right"><a href="javascript:verframe('menu.php?redirect=menu');" class="letrasMenu"  >OFICINA VIRTUAL</a></div></td>
                      ...
                      <tr>
                        <td><div align="right">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="12%" class="style11">&nbsp;</td>
                                <td width="79%" height="21" class="style11"><div align="right"><a href="javascript:verframe('f_acerca.php?redirect=f_acerca');" class="letrasMenu" >CONÓCENOS</a></div></td>
                      ...
                      <tr>
                        <td><div align="right">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="13%" class="style11">&nbsp;</td>
                                <td width="82%" height="21" class="style11"><div align="right"><a href="javascript:verframe('f_contacto.php?redirect=f_contacto');" class="letrasMenu"  >CONTACTO</a></div></td>
          ...
          <div id="main">
              ...
              <div id="center">
                  <div id="clientContainer">
                    <iframe src="<?php  if($inicio!="") echo"$inicio"; else if($_SESSION['usuario']=="") echo"f_home.php"; else echo"menu.php";?>" name="myframe" id="myframe" scrolling="auto" width="823px" height="658px" style="background-image:url(images/fondo_lista.jpg)"></iframe>
                  </div>
              </div>
          </div>
