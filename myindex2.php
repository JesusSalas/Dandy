...
<script>(function(d, s, id) {
  ...
  <tr>
    <td><div align="center"><A NAME="ventan"></A><a href="javascript:verframe('lista2.php?id=1');" class="letrasMenu" >ALIMENTOS</a></div></td>
    <td><img src="assets/imgs/separador_naranja.jpg" /></td>
    <td><div align="center"><a href="javascript:verframe('lista2.php?id=2');" class="letrasMenu" >VIDA NOCTURNA</a></div></td>
    <td><img src="assets/imgs/separador_naranja.jpg" /></td>
    <td><div align="center"><a href="javascript:verframe('lista2.php?id=3');" class="letrasMenu" >COMPRAS</a></div></td>
    <td><img src="assets/imgs/separador_naranja.jpg" /></td>
    <td><div align="center"><a href="javascript:verframe('lista2.php?id=4');" class="letrasMenu" >ENTRETENIMIENTO</a></div></td>
    <td><img src="assets/imgs/separador_naranja.jpg" /></td>
    <td><div align="center"><a href="javascript:verframe('lista2.php?id=5');" class="letrasMenu" >ACTIVIDADES</a></div></td>
    <td><img src="assets/imgs/separador_naranja.jpg" /></td>
    <td><div align="center"><a href="javascript:verframe('lista2.php?id=6');" class="letrasMenu" >SERVICIOS</a></div></td>
  </tr>
</table>
