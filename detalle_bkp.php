...
<table width="806" border="0"  cellpadding="0" cellspacing="0">
  <tr>
    <td height="96" valign="top" background="images/titulo_detalle_<? echo"$header";?>.jpg"><table width="730" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
  ...
  <tr>
    <td height="24" valign="top"><table width="806" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="302"><img src="images/titulo_detalle_2_<? echo"$header";?>.jpg" width="302" height="208" /></td>
        <td><img src="assets<? echo"$res[32]";?>" width="227" height="208" /></td>
    ...
    <td height="114" valign="top" background="images/detalle_direccion.jpg"><table width="730" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><div align="left" class="style1">
          <div align="center"><span class="direccionDetalle"><? echo"$res[2]";?><br /></span></div>
        </div></td>
      </tr>
      <tr>
        <td height="35"><div align="center"><span class="referenciaDetalle"><? echo"$res[3]";?></span> <span class="horarioDetalle"><? echo"$res[6]";?></span></div></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td height="100%" valign="top" background="images/fondo_lista.jpg" bgcolor="#000000"><table width="680" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="300" valign="top"><table width="300" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td ><div align="left" class="tituloDetalle"><? echo"$res[1]";?></div></td>
            </tr>
            <tr>
              <td><img src="images/franja_detalle.png" width="346" height="11" /></td>
            </tr>
            <tr>
              <td class="style1"><div align="justify" class="textoDetalle"><? echo"$res[13]";?></div></td>
            </tr>
          </table></td>
          <td width="20" rowspan="9"><img src="images/spacer.gif" width="40" height="20" /></td>
          <td width="430"><img src="assets/<? echo"$res[10]";?>" width="358" height="269" /></td>
        </tr>
        <tr>
          ...
          <td valign="top"><table width="300" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td valign="top" class="style1"><div align="justify"><p>
                  <iframe width="347" height="202" frameborder="0" scrolling="No" marginheight="0" marginwidth="0" src="<? echo"$res[11]";?>&output=embed"></iframe>
                  <br />
                  <small><a href="<? echo"$res[11]";?>" target="_blank" class="contenidoNegritas" >Ver mapa m&aacute;s grande</a></small></p></div></td>
            </tr>
          </table></td>
          <td valign="top"><table width="300" border="0" cellspacing="0" cellpadding="0">
              <tr>
              ...
              <tr>
                <td class="style1"><div align="justify">
                    <p><span class="benedicioTipo">DeLuxe</span><br />
                        <span class="benedicio"><? echo"$res[24]";?></span><br />
                        <span class="vigenciaBeneficio"><? echo"$res[30]";?></span></p>
                  <p><span class="benedicioTipo2">Diamond</span><br />
                        <span class="benedicio"><? echo"$res[25]";?></span><br />
                        <span class="vigenciaBeneficio"><? echo"$res[31]";?></span></p>
                </div></td>
              </tr>
            </table></td>
        </tr>
        ...
        <tr>
          <td valign="top"><table width="300" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="style1"><div align="left"><p><span class="textoDetalle">Tel: <? echo"$res[4]";?>
...
<? }?> </span>
                <? if($res[7]!=""){?>
<br/>
<a href="<? echo"$res[7]";?>" target="_blank" class="textoDetalle"><? echo"$res[7]";?></a>
<? }?>
<? if($res[8]!=""){?>
<br/>
<a href="<? echo"$res[8]";?>" target="_blank" class="textoDetalle"><? echo"$res[8]";?></a>
<? }?></div></p></td>
            </tr>
          </table></td>
          <td valign="top"><table width="300" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="style2"><div align="left" class="tituloDetalle"><? echo"$res[34]";?></div></td>
            </tr>
            <tr>
              <td><img src="images/franja_detalle.png" width="346" height="11" /></td>
            </tr>
	...
	while(@mysql_num_rows($resultado)>=$count)
	{
		...
		?>
                  <a href="zoom.php?id=<? echo"$res_img[1]";?>" class="iframe"><img  src='assets/fotos/chica_<? echo"$res_img[1]";?>' border="0" /></a>
                  <?
		$count++;
	}
        ?>
        ...
        <tr>
          <td valign="bottom" class="tituloDetalle"><? if($res[16]!=""){?>Galería<? }?></td>
          <td>&nbsp;</td>
        </tr>
      </table>      </td>
  </tr>
